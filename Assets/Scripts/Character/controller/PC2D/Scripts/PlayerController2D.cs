...
public class PlayerController2D : MonoBehaviour
{
	...
	private PC2D.PlatformerAnimation2D _playerAnim;
    ...
    void Update()
    {
		...
		_isShooting = Input.GetButton("Shoot");
		...
		if (_isAttacking || _isCountring || _isBlocking || _heroCombat.IsStablizie() || _isShooting) {
			_motor.normalizedXMovement = 0;
