    ...
    public class ProCamera2DPanAndZoomEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (proCamera2DPanAndZoom.AllowPan)
            {
                ...
                {
                    EditorGUI.indentLevel = 2;
                    _tooltip = new GUIContent("Edges Pan Speed", "");
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("EdgesPanSpeed"), _tooltip);
                
                    _tooltip = new GUIContent("Horizontal Pan Edges", "If the mouse pointer goes beyond this edge the camera will start moving");
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("HorizontalPanEdges"), _tooltip);

                    _tooltip = new GUIContent("Vertical Pan Edges", "If the mouse pointer goes beyond this edge the camera will start moving");
